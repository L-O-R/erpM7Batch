...
class Asset(Entity):
    ...
    def calculate_depreciation(self, years):
        current_val = self.__value * (0.9 ** years)
...
class Hardware(Asset):
    ...
    def get_details(self):
        ...
        return f'{base_data} | condition: {self.condition}'
...
class Software(Asset):
    ...
    def get_details(self):
        base_date = super().get_details()
        return f'{base_date} | expiry_date: {self.expiry_date}'